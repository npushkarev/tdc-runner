...
> **Кому что читать.** Разработчику компонента нужен [confluence.md](confluence.md):
> что сделано, как завести свои тесты, как запустить. Без устройства системы.
...
![A · Контекст](../schemes/in662_arch_context.png)
...
![B · Слои](../schemes/in662_arch_layers.png)
...
![E · Страховочный слой](../schemes/in662_arch_hardening.png)
...
![F · Секреты](../schemes/in662_arch_secrets.png)
