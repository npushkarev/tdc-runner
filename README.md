...
Профили конкретных команд в этом репозитории не хранятся: единственный пример —
`tests/fixtures/demo_repo`, он же гоняется смоуком, он же служит фикстурой
юнит-тестов. Пилотные профили живут у своих команд.
